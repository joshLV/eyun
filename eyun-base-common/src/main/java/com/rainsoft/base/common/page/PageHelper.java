package com.rainsoft.base.common.page;
...
public class PageHelper implements Interceptor {
	 ...
	 * @param pageSize
	 */
	public static void startPageWithStartRowNum(int pageSize,int startRow) {
		Page page = new Page(0, pageSize, Page.SQL_COUNT);
		page.setStartRow(startRow);
		page.setEndRow(startRow+pageSize);
		localPage.set(page);
