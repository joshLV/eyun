...
public class DesUtil {
		...
		private static String key = SystemConfigUtil.getValue("DES_KEY");//加密的秘钥，加密和解密的秘钥一定要一致
		 ...
		 * @throws Exception
		 */
		public static String encrypt4phone(String data) {
			String strs = "";
			try {
		 ...
		 * @throws Exception
		 */
		public static String decrypt4phone(String data)  {
			String str = "";
			if (data == null){
				return null;
			}
