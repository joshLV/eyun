...
<%@ include file="/common/jsp/taglib.jsp"%>
	...
	<div id="dialog" title="场所资料详情" style="display: none;width:501px">
		<table width="650" cellpadding="0" cellspacing="0"  class="PublicTable">
			<tr>
				<td>场所名称：</td>
			...
			<tr>
				<td>备注：</td>
				<td><textarea id="remarks" readonly style="margin: 2px; width: 278px; height: 73px;resize: none">
				 </textarea></td>
			</tr>
		</table>
	</div>
<script type="text/javascript">
    $(function () {
        ...
        //grid加载
        $("#gridTable").jqGrid({
            url: '${ctx}/systemManage/place/bySearch.do',
            height: 'auto',
            ...
            colModel: [
                ...
                {name: 'addr', index: 'addr', align: 'center', width: '40'},
                {name: 'areaName', index: 'areaName', align: 'center', width: '40'},
