	...
	$(function(){
		$("#gridTable").jqGrid({
			...
			colModel:[
				...
				{name:'surfWay',index:'surfWay', align: 'center', width : '25'},
	...
	function saveSurfWebSet() {
		showMsg("确定保存上网设置吗？", 2, function() {
			...
			$.ajax({
				...
				type : 'post',
				dataType : 'json',
				data : {'placeId' : placeId, 'placeCode' : placeCode, 'freeTime' : freeTime, 'placeCtrlCode' : placeCtrlCode, 'feeCtrlCode' : feeCtrlCode, 'creator' : creator},
