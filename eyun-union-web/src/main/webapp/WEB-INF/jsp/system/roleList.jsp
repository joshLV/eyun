		...
		<form>
			<table class="PublicTable">
				<tr>
					...
					<td>
						<input type="text" name="baseRole.name" id="name" class="PublicText" maxlength="20"/>
					</td>
				</tr>
				<tr>
					<td>
...
<script type="text/javascript">
	...
	$(function(){
		$("#gridTable").jqGrid({
			url:'${ctx}/system/baserole/getGridList.do',
			mtype : 'post',
			datatype : "json",
			height: 'auto',
	...
	function delRole(id){
		...
		var num = ids.length;
		for(var i = 0; i < num; i++) {
			dataRow = $("#gridTable").jqGrid("getRowData",ids[i]);
			datas.push({"id":dataRow.id});
		}
