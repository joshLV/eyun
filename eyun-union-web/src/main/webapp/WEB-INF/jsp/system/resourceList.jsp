	...
	$(function(){
		$("#datePickerLeft").datepicker({
			...
			onClose : function(selectedDate) {
				$("#datePickerRight").datepicker("option", "minDate", selectedDate);
			}
		});
		...
		$("#datePickerRight").datepicker({
			...
			maxDate : "-1M",
			onClose : function(selectedDate) {
				$("#datePickerLeft").datepicker("option", "maxDate", selectedDate);
			}
		});
		...
		$("#gridTable").jqGrid({
			...
			colModel:[
				...
				{name:'typeName',index:'type',align: 'center', width : '10'},
				{name:'remark',index:'remark', align: 'center', width : '10'},
				{name:'url',index:'url', align: 'center', width : '15'},
				{name:'icon',index:'icon', align: 'center', width : '8'},
				{name:'creatorName',index:'creator', sorttype:"string", align: 'center', width : '8'},
				...
				{name:'operate',index:'operate',sortable: false, align: 'center', width : '9'},
