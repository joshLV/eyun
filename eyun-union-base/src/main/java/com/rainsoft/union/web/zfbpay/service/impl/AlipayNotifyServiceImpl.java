package com.rainsoft.union.web.zfbpay.service.impl;
...
public class AlipayNotifyServiceImpl implements IAlipayNotifyService{
	 ...
	 * @Description:生成签名结果
	 * @author:王乾
	 * @date:2016年5月20日下午5:46:33
	 * @param entity
	 * @return
	 */
	public String getSignResult(Object entity) {
		Map<String, String> dataMap = BeanMapUtil.beanToMap(entity);
		dataMap = Util.paramsFilter(dataMap);
		String paramsStr = Util.createLinkString(dataMap);
		String mysign = "";
		if("MD5".equals(AlipayConfig.sign_type)) {
			mysign = MD5.sign(paramsStr, AlipayConfig.key, AlipayConfig.input_charset);
		}
		return mysign;
	}
