...
import com.rainsoft.base.common.utils.DigestUtil;
...
@Service("paymentForOnlineService")
public class PaymentForOnlineServiceImpl implements IPaymentForOnlineService{

    private static final Logger log = LoggerFactory.getLogger(PaymentForOnlineServiceImpl.class);
    ...
    public QueryResult queryByOrder(String p2_Order) {
        ...
        try {
            ...
            responseStr = HttpUtil.getUrl(queryRefundReqURL, reParams);
